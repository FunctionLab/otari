...
class SeiPredictor:
    def __init__(self, genome, strand_specific = False, use_cuda = False):
        sei_model_path = os.path.join(CWD_DIR, '/mnt/home/alitman/ceph/otari/resources/model_weights/sei.pth')
        distinct_features_path = os.path.join(CWD_DIR, '/mnt/home/alitman/ceph/otari/resources/model_weights/sei.target.names')
        histone_features_path = os.path.join(CWD_DIR, '/mnt/home/alitman/ceph/otari/resources/model_weights/histone_features.csv')
